...
import { Menu, X, LogOut, BarChart3, Wrench, Settings, Mail } from 'lucide-react';
...
export default function ProviderDashboardLayout({
  ...
  const MENU = [
    { href: '/provider-dashboard', label: 'Mi Panel', icon: BarChart3 },
    { href: '/provider-dashboard/servicios', label: 'Mis Servicios', icon: Wrench },
    { href: '/provider-dashboard/proyectos', label: 'Mis Proyectos', icon: Settings },
    { href: '/provider-dashboard/mensajes', label: 'Mensajes', icon: Mail },
  ];
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-white/10">
          <Link href="/provider-dashboard" className="font-display font-bold text-lg">
        ...
        <div className="px-4 py-4 border-b border-white/10">
          <p className="text-sm text-white/70">Proveedor</p>
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white border-b border-gray-200 px-4 lg:px-8 py-4 flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold text-brayton-navy">Panel de Proveedor</h1>
          <div />
        </header>
