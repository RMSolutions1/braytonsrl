...
export default function EmployeeDashboardLayout({
  ...
  const MENU = [
    { href: '/employee-dashboard', label: 'Mi Panel', icon: BarChart3 },
    { href: '/employee-dashboard/tareas', label: 'Mis Tareas', icon: Wrench },
    { href: '/employee-dashboard/proyectos', label: 'Proyectos', icon: Settings },
    { href: '/employee-dashboard/mensajes', label: 'Mensajes', icon: Mail },
  ];
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-white/10">
          <Link href="/employee-dashboard" className="font-display font-bold text-lg">
        ...
        <div className="px-4 py-4 border-b border-white/10">
          <p className="text-sm text-white/70">Empleado</p>
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white border-b border-gray-200 px-4 lg:px-8 py-4 flex items-center justify-between">
          ...
          <h1 className="text-2xl font-bold text-brayton-navy">Panel de Empleado</h1>
          <div />
        </header>
